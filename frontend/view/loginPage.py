...
class LoginPage(ft.UserControl):
    ...
    def handle_login(self, e):
        if self.on_login:
            ...
            [isLoggedIn, message] = self.login_manager.login(username=username, password=password)
            self.on_login(username=username, password=password, isLoggedIn=isLoggedIn, message=message)
